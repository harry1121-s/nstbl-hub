...
//     function previewMaxRedeemAmount() external view returns(uint256 nstblAmount_) {

//         uint256[] memory balances = _getAssetBalances();
//         uint256 tvl = balances[0] + balances[1] + balances[2];
//         uint256[] memory redemptionAllocation = new uint256[](2);
//         redemptionAllocation[0] = balances[1] * 1e18 / tvl;
//         redemptionAllocation[1] = balances[2] * 1e18 / tvl;

//         nstblAmount_ = (stablesBalances[USDC]*1e12 * tvl) / balances[0];
//         require((redemptionAllocation[0] * nstblAmount_)/1e30 <= stablesBalances[USDT], "insufficient USDT Balance");
//         require((redemptionAllocation[1] * nstblAmount_)/1e18 <= stablesBalances[DAI], "insufficient DAI Balance");
